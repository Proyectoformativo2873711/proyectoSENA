document.getElementById('registroForm').addEventListener('submit', function(e) {
    ...
    if (isValid) {
        ...
        localStorage.setItem('userData', JSON.stringify({
            ...
            email: email.value,
            contrasena: contrasena.value, // Asegúrate de que la contraseña se guarda aquí
            programa: programa.value,
            rol: rol.value
        }));

        // Redirigir a la página según el programa seleccionado
        let redirectUrl = '';
        switch (programa.value) {
            case 'metrologia':
                redirectUrl = '/inicio_metrologia/metrologia.html';
                break;
            case 'sennovalab':
                redirectUrl = '/inicio_sennovalab/sennovalab.html';
                break;
            case 'ambos':
                redirectUrl = 'inicio_sesion.html';
                break;
            default:
                redirectUrl = 'inicio_sesion.html';
                break;
        ...
        showNotification('Registro completado. Redirigiendo...');
    }
});
